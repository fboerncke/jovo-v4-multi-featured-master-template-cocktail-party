  ...
  START() {
    return this.$send(YesNoOutput, {
      ...
      card: {
        ...
        subtitle: 'Enjoy the party!',
        content: this.$component.config?.prompt as string,
        imageUrl:
          'https://images.pexels.com/photos/2663974/pexels-photo-2663974.jpeg?auto=compress&cs=tinysrgb&w=500',
        backgroundImageUrl: 'https://jovo-assets.s3.amazonaws.com/jovo-bg.png',
        header: {
          logo: 'https://images.pexels.com/photos/2663974/pexels-photo-2663974.jpeg?auto=compress&cs=tinysrgb&w=500',
          title: 'Cocktail Party!',
        },
      },
